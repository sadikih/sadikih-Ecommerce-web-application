<?php
	include'header.php';
	//require'header.php';
	$main_id=$_REQUEST['m_id'];
	$sub_id=$_REQUEST['s_id'];
	//echo $main_id. $sub_id;
?>
...
<?php
if(isset($main_id) && isset($sub_id)){
	
require_once('class_lib/user_product_class.php');
$products_obj=new User_Product;
$products=$products_obj->product_categ_view($_REQUEST);
								...
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									...
									<div class="block2-overlay trans-0-4">
										...
										<div class="block2-btn-addcart w-size1 trans-0-4">
											<!-- Button -->
											<a href="single_product.php?p_code=<?php echo $prod_code; ?>" target="_blank" role="button" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
												Add to Cart
											</a>
										</div>
									</div>
